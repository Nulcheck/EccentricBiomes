...
public class DeadwoodDoor extends Block {
	private IIcon[] iconTop;
	private IIcon[] iconBottom;

	public DeadwoodDoor(Material mat) {
		super(mat);
		float f = 0.5F;
		float f1 = 1.0F;
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.iconTop[0] = reg.registerIcon("mod_ebm:door_dead_upper");
		this.iconBottom[0] = reg.registerIcon("mod_ebm:door_dead_lower");
