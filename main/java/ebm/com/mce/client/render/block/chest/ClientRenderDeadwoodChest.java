...
public class ClientRenderDeadwoodChest extends TileEntitySpecialRenderer {
	...
	public ClientRenderDeadwoodChest() {
	...
	public void renderTileEntityChestAt(TileEntityDeadwoodChest par1TileEntityChest, double par2, double par4,
		...
		if (!par1TileEntityChest.hasWorldObj()) {
			...
			if (block instanceof DeadwoodChest && i == 0) {
				try {
					((DeadwoodChest) block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(),
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		renderTileEntityChestAt((TileEntityDeadwoodChest) par1TileEntity, par2, par4, par6, par8);
	}
}
