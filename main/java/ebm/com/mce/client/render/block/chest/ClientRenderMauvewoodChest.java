package ebm.com.mce.client.render.block.chest;
...
public class ClientRenderMauvewoodChest extends TileEntitySpecialRenderer {
	private static final ResourceLocation trap_double = new ResourceLocation("mod_ebm",
			"/textures/entity/chest/trapped_double_mauve.png".substring(1));

	private static final ResourceLocation trap_single = new ResourceLocation("mod_ebm",
			"/textures/entity/chest/trapped_mauve.png".substring(1));

	private static final ResourceLocation normal_double = new ResourceLocation("mod_ebm",
			"/textures/entity/chest/normal_double_mauve.png".substring(1));

	private static final ResourceLocation normal_single = new ResourceLocation("mod_ebm",
			"/textures/entity/chest/normal_mauve.png".substring(1));
	...
	private static final ResourceLocation bday_single = new ResourceLocation("mod_ebm",
			"/textures/entity/chest/bday.png".substring(1));

	private static final ResourceLocation bday_double = new ResourceLocation("mod_ebm",
	...
	public ClientRenderMauvewoodChest() {
	...
	public void renderTileEntityChestAt(TileEntityMauvewoodChest par1TileEntityChest, double par2, double par4,
		...
		if (!par1TileEntityChest.hasWorldObj()) {
			...
			if (block instanceof MauvewoodChest && i == 0) {
				try {
					((MauvewoodChest) block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(),
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		renderTileEntityChestAt((TileEntityMauvewoodChest) par1TileEntity, par2, par4, par6, par8);
	}
}
