...
public class TileEntityMauvewoodChest extends TileEntity implements IInventory {
	private ItemStack[] chestContents = new ItemStack[36];
	public boolean adjacentChestChecked;
	public TileEntityMauvewoodChest adjacentChestZNeg;
	public TileEntityMauvewoodChest adjacentChestXPos;
	public TileEntityMauvewoodChest adjacentChestXNeg;
	public TileEntityMauvewoodChest adjacentChestZPos;
	...
	public TileEntityMauvewoodChest() {
		this.cachedChestType = -1;
	}

	@SideOnly(Side.CLIENT)
	public TileEntityMauvewoodChest(int i) {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.mauveChest";
	}
	...
	private void adjacentChest(TileEntityMauvewoodChest te, int i) {
		if (te.isInvalid()) {
			this.adjacentChestChecked = false;
	...
	public void checkForAdjacentChests() {
		if (!this.adjacentChestChecked) {
			...
			if (this.validateChest(this.xCoord - 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXNeg = (TileEntityMauvewoodChest) this.worldObj.getTileEntity(this.xCoord - 1,
						this.yCoord, this.zCoord);
			}

			if (this.validateChest(this.xCoord + 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXPos = (TileEntityMauvewoodChest) this.worldObj.getTileEntity(this.xCoord + 1,
						this.yCoord, this.zCoord);
			}

			if (this.validateChest(this.xCoord, this.yCoord, this.zCoord - 1)) {
				this.adjacentChestZNeg = (TileEntityMauvewoodChest) this.worldObj.getTileEntity(this.xCoord,
						this.yCoord, this.zCoord - 1);
			}

			if (this.validateChest(this.xCoord, this.yCoord, this.zCoord + 1)) {
				this.adjacentChestZPos = (TileEntityMauvewoodChest) this.worldObj.getTileEntity(this.xCoord,
						this.yCoord, this.zCoord + 1);
			}
	...
	private boolean validateChest(int x, int y, int z) {
		if (this.worldObj == null) {
			...
			return block instanceof MauvewoodChest && ((MauvewoodChest) block).meta == this.getChestType();
		}
	}
	...
	public void closeInventory() {
		if (this.getBlockType() instanceof MauvewoodChest) {
			--this.numPlayersUsing;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1,
					this.numPlayersUsing);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
	...
	public int getChestType() {
		if (this.cachedChestType == -1) {
			if (this.worldObj == null || !(this.getBlockType() instanceof MauvewoodChest)) {
				return 0;
			}

			this.cachedChestType = ((MauvewoodChest) this.getBlockType()).meta;
		}
