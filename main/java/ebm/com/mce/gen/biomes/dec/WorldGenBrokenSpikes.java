...
public class WorldGenBrokenSpikes extends WorldGenerator {
				...
				for (int i2 = -k1; i2 <= k1; ++i2) {
					...
					if ((l1 == 0 && i2 == 0 || f1 * f1 + f2 * f2 <= f * f)
						...
						if (block.getMaterial() == Material.air || block == Blocks.dirt) {
							this.func_150515_a(world, x + l1, y + j1 + 10, z + i2, blockA);
						}
						...
						if (j1 != 0 && k1 > 1) {
							...
							if (block.getMaterial() == Material.air || block == Blocks.dirt) {
								this.func_150515_a(world, x + l1, y - j1 - 5, z + i2, blockA);
							}
						}
					}
				}
				...
				while (true) {
					if (l1 > 15) {
						...
						if (block1.getMaterial() == Material.air || block1 == Blocks.dirt || block1 == blockA) {
							this.func_150515_a(world, x + j2, l1 + 5, z + k1, blockA);
							--l1;
							--k2;
