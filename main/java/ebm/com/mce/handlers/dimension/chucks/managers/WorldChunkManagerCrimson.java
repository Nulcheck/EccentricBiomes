package ebm.com.mce.handlers.dimension.chucks.managers;
...
import ebm.com.mce.handlers.dimension.layers.CrimsonGenLayer;
...
public class WorldChunkManagerCrimson extends WorldChunkManager {
	public static ArrayList<BiomeGenBase> allowBiomes = new ArrayList<BiomeGenBase>(
			Arrays.asList(BiomeRegistry.CrimsonObsidian, BiomeRegistry.CrimsonPlains, BiomeRegistry.CrimsonForest,
					BiomeRegistry.CrimsonMountains, BiomeRegistry.CrimsonDesert));
	...
	protected WorldChunkManagerCrimson() {
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList();
		this.biomesToSpawnIn.addAll(allowBiomes);
	}

	public WorldChunkManagerCrimson(long seed, WorldType worldType) {
		this();
		GenLayer[] agenlayer = CrimsonGenLayer.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerCrimson(World world) {
