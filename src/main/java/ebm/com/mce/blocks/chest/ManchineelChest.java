...
public class ManchineelChest extends BlockContainer {
	private final Random rand = new Random();
	public final int meta;

	public ManchineelChest(int meta) {
		super(Material.wood);
		this.meta = meta;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
			((TileEntityManchineelChest) world.getTileEntity(x, y, z)).getName(stack.getDisplayName());
		}
	}
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, Block block) {
		...
		TileEntityManchineelChest tileentitychest = (TileEntityManchineelChest) world.getTileEntity(x, y, z);
	...
	public IInventory makeLargeChest(World world, int x, int y, int z) {
		Object object = (TileEntityManchineelChest) world.getTileEntity(x, y, z);
		...
		if (object == null) {
			...
			if (world.getBlock(x - 1, y, z) == this) {
				object = new InventoryLargeChest("container.mChestDouble",
						(TileEntityManchineelChest) world.getTileEntity(x - 1, y, z), (IInventory) object);
			}

			if (world.getBlock(x + 1, y, z) == this) {
				object = new InventoryLargeChest("container.mChestDouble", (IInventory) object,
						(TileEntityManchineelChest) world.getTileEntity(x + 1, y, z));
			}

			if (world.getBlock(x, y, z - 1) == this) {
				object = new InventoryLargeChest("container.mChestDouble",
						(TileEntityManchineelChest) world.getTileEntity(x, y, z - 1), (IInventory) object);
			}

			if (world.getBlock(x, y, z + 1) == this) {
				object = new InventoryLargeChest("container.mChestDouble", (IInventory) object,
						(TileEntityManchineelChest) world.getTileEntity(x, y, z + 1));
			}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		// TileEntityManchineelChest tileentitychest = new
		// TileEntityManchineelChest();
		return new TileEntityManchineelChest();
	}
	...
	public int isProvidingWeakPower(IBlockAccess blockacc, int x, int y, int z, int meta) {
		if (!this.canProvidePower()) {
			...
			int i1 = ((TileEntityManchineelChest) blockacc.getTileEntity(x, y, z)).numPlayersUsing;
	...
	public void registerBlockIcons(IIconRegister icon) {
		this.blockIcon = icon.registerIcon("mod_ebm:planks_m");
	}
