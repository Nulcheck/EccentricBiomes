...
public class MauvewoodDoor extends Block {
	private IIcon[] iconTop;
	private IIcon[] iconBottom;

	public MauvewoodDoor(Material mat) {
		super(mat);
		float f = 0.5F;
		float f1 = 1.0F;
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		this.iconTop[0] = reg.registerIcon("mod_ebm:door_mauvewood_upper");
		this.iconBottom[0] = reg.registerIcon("mod_ebm:door_mauvewood_lower");
	...
	public Item getItem(World world, int x, int y, int z) {
		return mod_ebm.mauvewoodDoorItem;
	}
