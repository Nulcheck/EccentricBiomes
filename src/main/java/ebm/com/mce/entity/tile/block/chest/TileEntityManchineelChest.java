package ebm.com.mce.entity.tile.block.chest;
...
public class TileEntityManchineelChest extends TileEntity implements IInventory {
	private ItemStack[] chestContents = new ItemStack[36];
	public boolean adjacentChestChecked;
	public TileEntityManchineelChest adjacentChestZNeg;
	public TileEntityManchineelChest adjacentChestXPos;
	public TileEntityManchineelChest adjacentChestXNeg;
	public TileEntityManchineelChest adjacentChestZPos;
	...
	public TileEntityManchineelChest() {
		this.cachedChestType = -1;
	}

	@SideOnly(Side.CLIENT)
	public TileEntityManchineelChest(int i) {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.mChest";
	}
	...
	private void adjacentChest(TileEntityManchineelChest te, int i) {
		if (te.isInvalid()) {
			this.adjacentChestChecked = false;
	...
	public void checkForAdjacentChests() {
		if (!this.adjacentChestChecked) {
			...
			if (this.validateChest(this.xCoord - 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXNeg = (TileEntityManchineelChest) this.worldObj.getTileEntity(this.xCoord - 1,
						this.yCoord, this.zCoord);
			}

			if (this.validateChest(this.xCoord + 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXPos = (TileEntityManchineelChest) this.worldObj.getTileEntity(this.xCoord + 1,
						this.yCoord, this.zCoord);
			}

			if (this.validateChest(this.xCoord, this.yCoord, this.zCoord - 1)) {
				this.adjacentChestZNeg = (TileEntityManchineelChest) this.worldObj.getTileEntity(this.xCoord,
						this.yCoord, this.zCoord - 1);
			}

			if (this.validateChest(this.xCoord, this.yCoord, this.zCoord + 1)) {
				this.adjacentChestZPos = (TileEntityManchineelChest) this.worldObj.getTileEntity(this.xCoord,
						this.yCoord, this.zCoord + 1);
			}

			if (this.adjacentChestZNeg != null) {
				this.adjacentChestZNeg.adjacentChest(this, 0);
			}

			if (this.adjacentChestZPos != null) {
				this.adjacentChestZPos.adjacentChest(this, 2);
			}

			if (this.adjacentChestXPos != null) {
				this.adjacentChestXPos.adjacentChest(this, 1);
			}

			if (this.adjacentChestXNeg != null) {
				this.adjacentChestXNeg.adjacentChest(this, 3);
			}
		}
	}

	private boolean validateChest(int x, int y, int z) {
		if (this.worldObj == null) {
			return false;
		} else {
			Block block = this.worldObj.getBlock(x, y, z);
			return block instanceof ManchineelChest && ((ManchineelChest) block).meta == this.getChestType();
		}
	}
	...
	public void closeInventory() {
		if (this.getBlockType() instanceof ManchineelChest) {
			--this.numPlayersUsing;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1,
					this.numPlayersUsing);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
	...
	public int getChestType() {
		if (this.cachedChestType == -1) {
			if (this.worldObj == null || !(this.getBlockType() instanceof ManchineelChest)) {
				return 0;
			}

			this.cachedChestType = ((ManchineelChest) this.getBlockType()).meta;
		}
