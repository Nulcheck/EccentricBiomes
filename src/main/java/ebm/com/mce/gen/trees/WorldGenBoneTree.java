...
public class WorldGenBoneTree extends WorldGenAbstractTree {
	public WorldGenBoneTree() {
		super(false);
	}
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		if (block != mod_ebm.boneBlock) {
			...
			for (int i = 0; i < base; i++) {
				buildBlock(world, x, y + h, z, mod_ebm.boneLog, 0);
				h++;
			}
	...
	public void generateTop(World world, int x, int y, int z) {
		buildBlock(world, x, y, z, mod_ebm.boneLog, 0);
	}

	public void generateBranch(World world, Random rand, int x, int y, int z, int p) {
		buildBlock(world, x, y, z, mod_ebm.boneLog, 0);
		buildBlock(world, x, y + 1, z, mod_ebm.boneLog, 0);
	}
